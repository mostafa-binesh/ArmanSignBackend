...
class OrderFilter(django_filters.FilterSet):
    ...
    category = django_filters.ChoiceFilter(choices=Order.CATEGORY_CHOICES)
    project_id = django_filters.NumberFilter(field_name="project", lookup_expr='exact', label="Operator ID")  # fill 'exact' if you want to filter by an exact match
